...
type SubmitRequest struct {
	...
	Payload              []*common.Envelope `protobuf:"bytes,3,rep,name=payload,proto3" json:"payload,omitempty"`
	Graph                *peer.Graph        `protobuf:"bytes,4,opt,name=graph,proto3" json:"graph,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *SubmitRequest) GetGraph() *peer.Graph {
	if m != nil {
		return m.Graph
	}
	return nil
...
var fileDescriptor_3cfb3b8ec240c376 = []byte{
	...
	,
}
